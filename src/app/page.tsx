...
const handleSetCurrentSlideIndex = (index: number) => {
  ...
  const handleDeleteSlide = () => {
    ...
    const updatedSlides = slides.filter((_, index) => index !== currentSlideIndex); // Remove the current slide from the slides array
    ...
    <div className="w-full flex flex-col items-center justify-center gap-2">
      ...
      <div className="min-w-[60%] h-[120px] bg-black rounded-md mt-6 relative flex items-center gap-2">
          ...
          {slides.length > 0 && slides.map((slide, index) => (
            <div key={index} className="w-[100px] h-[100px] bg-gray-900 rounded-lg text-[5px] hover:cursor-pointer relative"
